...
# Run tests
perform_test write "/dev/mmcblk0p12"
perform_test read "/dev/mmcblk0p12"
perform_test randwrite "/dev/mmcblk0p12"
perform_test randread "/dev/mmcblk0p12"
##perform_test readwrite "/dev/mmcblk0p12"
