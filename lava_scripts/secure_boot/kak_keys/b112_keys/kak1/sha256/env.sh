...
openssl x509 -req -days 3650 -in certificate_2048.csr -signkey private_key_2048.pem -sha256  -out certificate_2048.crt
...
openssl dgst -sha256  publickey_extracted_from_cert.der
