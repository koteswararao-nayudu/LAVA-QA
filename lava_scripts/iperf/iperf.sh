...
sync
/root/lava_scripts/results_copy.sh  /root/tmux_0_iperf.txt /lava/edgeq/perfreports/$build_id/$bsp_id $test_name.txt  equser@192.168.9.160 "Password\$2021" $test_suite
sync
