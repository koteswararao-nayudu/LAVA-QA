...
./tmux_session_commands.sh "iperf" "0" "iperf3 -s -u &"
./tmux_session_commands.sh "iperf" "0" "ps -aef | grep iperf3"

./tmux_session_commands.sh "iperf" "1" "clear;pwd"
./tmux_session_commands.sh "iperf" "1" "clear"
sleep 3
./tmux_session_commands.sh "iperf" "1" "sshpass -p 'Password\$2021' ssh \-o StrictHostKeyChecking=accept-new equser@192.168.251.11"
sleep 3
./tmux_session_commands.sh iperf 1 "ifconfig -a"
