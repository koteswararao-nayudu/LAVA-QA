...
subject1="EDGEQ GNB PLATFORM JENKINS"
...
#	build_date="061122"
	...
	build_number = subject_split_lst[5]
	command_ssh="/usr/bin/sh /home/equser/lava_edgeq_trigger.sh" +  " " + "raptor2_gnb_" + build_date + "_" + build_number 
	print(command_ssh)
