...
chan.setblocking(0)
chan.exec_command(' /usr/bin/python3 /home/equser/koti/lava-testcases/cronjobs/GP_Build_trigger_cronjob.py >> /home/equser/koti/lava-testcases/cronjobs/GP_logs_RC2.txt' )
